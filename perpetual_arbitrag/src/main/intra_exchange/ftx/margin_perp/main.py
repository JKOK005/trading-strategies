...
if __name__ == "__main__":
	...
	logging.info(f"Starting Ftx arbitrag bot with the following params: {args}")
	...
	if args.db_url is not None:
		...
		db_margin_client 	 = MarginClients(url = args.db_url, strategy_id = strategy_id, client_id = client_id, exchange = "ftx", symbol = args.margin_trading_pair, units = "vol").create_session()
		db_perpetual_clients = PerpetualClients(url = args.db_url, strategy_id = strategy_id, client_id = client_id, exchange = "ftx", symbol = args.perpetual_trading_pair, units = "lot").create_session()
