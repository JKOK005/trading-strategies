...
if __name__ == "__main__":
	...
	parser.add_argument('--alert_threshold', type=float, nargs='?', default=os.environ.get("ALERT_THRESHOLD"), help="If score exists above this threshold, send a push notification out on message channel.")
	...
	while True:
		...
		if max_score >= args.alert_threshold:
